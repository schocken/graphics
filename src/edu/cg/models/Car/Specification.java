...
public class Specification {
	...
	public static final double TIRE_OUT_RADIUS = .075;
	public static final double TIRE_IN_RADIUS = .055;
	...
	public static final double F_HOOD_LENGTH_2 = 2.5*TIRE_OUT_RADIUS;
	...
	public static final double F_HOOD_HEIGHT_1 = 1.75*TIRE_OUT_RADIUS;
	public static final double F_HOOD_HEIGHT_2 = 1.5*TIRE_OUT_RADIUS;
	...
	public static final double B_BASE_LENGTH = 5.0*TIRE_OUT_RADIUS;
	public static final double B_BASE_DEPTH = F_HOOD_DEPTH_1;
	// --> Top Box
	public static final double B_LENGTH = 7.0*TIRE_OUT_RADIUS;
	public static final double B_HEIGHT_2= F_HOOD_HEIGHT_1-B_BASE_HEIGHT;
	public static final double B_HEIGHT_1= 1.5*TIRE_OUT_RADIUS-B_BASE_HEIGHT;
